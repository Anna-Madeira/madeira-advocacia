            ...
            <div className="grid grid-cols-1 gap-8">
              <div className="bg-gray-100 p-8 rounded-lg">
                <p className="text-gray-700 mb-4  italic">
                  O Direito de Família lida com as relações mais íntimas, exigindo um olhar humano e estratégico. A Dra. Teresa Cristina Madeira oferece suporte jurídico completo e empático para guiar você em cada etapa, sempre buscando o bem-estar de todos os envolvidos, especialmente das crianças.
